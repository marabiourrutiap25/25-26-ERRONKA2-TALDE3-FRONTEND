<template>
  <div class="container">
    <div class="d-flex justify-content-between align-items-center my-4">
      <h2 class="mb-0">Gestión de Produktuak</h2>
    </div>
...
const tableName = "consumables" // Nombre de la tabla en la API

// 🔹 Cargar datos iniciales
const cargarDatos = async () => {
  try {
    Produktuak.value = await Api.cargarObjetos(tableName)
    console.log("Datos cargados:", Produktuak.value)
  } catch (error) {
